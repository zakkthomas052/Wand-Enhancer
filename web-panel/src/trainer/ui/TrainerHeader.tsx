            ...
            <div className="relative flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="font-mono text-[9.5px] font-bold uppercase tracking-[0.16em] text-(--deck-accent)">
                            <Trans>Trainer Active</Trans>
                        </span>
                    </div>
                    <h2 className="mt-1 truncate text-base font-bold leading-tight text-(--deck-fg)">
                    ...
                    <div className="mt-1 flex min-w-0 items-center gap-2.5 font-mono text-[11px] text-(--deck-fg-3)">
                        ...
                        {trainer.gameVersion ? (
                            <span className="shrink-0">· v{trainer.gameVersion}</span>
                        ) : null}
                ...
                >
                    <Icon
                        className={cn(
                            'size-4',
                            isPinned ? 'drop-shadow-[0_0_5px_var(--deck-accent)]' : '',
                        )}
                        name={isPinned ? 'star-filled' : 'star'}
                    />
                </button>
            </div>
        </section>
...
const FallbackCover = () => {
    return (
        <div className="relative size-16 shrink-0 overflow-hidden rounded-[10px] border border-white/6 bg-[linear-gradient(135deg,rgba(238,0,255,0.28),rgba(0,0,0,0.48))] shadow-[inset_0_0_0_1px_rgba(255,255,255,.04),0_2px_6px_rgba(0,0,0,.35)]">
            ...
            <div className="absolute inset-x-1 bottom-1 truncate font-mono text-[8px] font-bold uppercase tracking-wider text-white/85 drop-shadow">
                WAND
            </div>
        </div>
    );
