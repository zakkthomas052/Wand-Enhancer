...
const ICON_PATHS: Record<IconName, ReactNode> = {
    ...
    gamepad: (
        <>
            <path d="M6 11h12a4 4 0 0 1 4 4v1a3 3 0 0 1-5.2 2L15 16H9l-1.8 2A3 3 0 0 1 2 16v-1a4 4 0 0 1 4-4z" />
            <path d="M7 15h4" />
            <path d="M9 13v4" />
    ...
    hammer: (
        <>
            <path d="M14 5 5 14" />
            <path d="m4 15 5 5" />
            <path d="M12 3h5l4 4-3 3-4-4" />
        </>
    ),
    'heart-broken': (
        <path d="M20 8.5c0 6-8 11.5-8 11.5S4 14.5 4 8.5A4.5 4.5 0 0 1 12 6a4.5 4.5 0 0 1 8 2.5zM12 6l-2 4 4 2-2 4" />
    ),
    list: (
        <>
            <path d="M4 6h16" />
